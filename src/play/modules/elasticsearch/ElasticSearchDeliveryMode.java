...
public class ElasticSearchDeliveryMode {
  ...
  /** The LOCAL. */
  public final static ElasticSearchDeliveryMode LOCAL = new ElasticSearchDeliveryMode(
      new LocalIndexEventHandler());

  /** The Synchronous. */
  public final static ElasticSearchDeliveryMode SYNCHRONOUS = new ElasticSearchDeliveryMode(
      new SynchronousIndexEventHandler());

  /** The Discard all messages. */
  public final static ElasticSearchDeliveryMode DISCARD = new ElasticSearchDeliveryMode(
  ...
  public static ElasticSearchDeliveryMode createCustomIndexEventHandler(final String clazzName) {
    try {
      ...
      throw new IllegalArgumentException(
          "Illegal className " + clazzName + " specified or class not in classpath");
