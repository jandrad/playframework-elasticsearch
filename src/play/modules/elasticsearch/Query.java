...
public class Query<T extends Model> {
  ...
  private final List<AggregationBuilder> facets;
   ...
   * @return self
   */
  public Query<T> addFacet(AggregationBuilder facet) {
  ...
  public SearchResults<T> fetch() {
    ...
    // Facets
    for (AggregationBuilder facet : facets) {
