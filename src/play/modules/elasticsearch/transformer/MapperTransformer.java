 ...
 *
 * <p>
 * Since this transformer uses a {@link ModelMapper} to handle model inflation, it supports
 * everything handled by the available mappers.
 * <p>
...
public class MapperTransformer<T extends Model> implements Transformer<T> {
  ...
  public SearchResults<T> toSearchResults(SearchResponse searchResponse, Class<T> clazz) {
    ...
    // Return Results
    return new SearchResults<T>(count, objects, scores, sortValues,
