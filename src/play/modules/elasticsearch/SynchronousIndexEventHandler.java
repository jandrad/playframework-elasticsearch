...
/**
 * Handles events in the same thread as they arrive, circumventing indexer. This can be useful for
 * testing or if you want to want to index a lot of entities within a single job that you manage
 * yourself.
 *
